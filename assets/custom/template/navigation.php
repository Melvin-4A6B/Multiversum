<nav class="navbar navbar-expand-lg navbar-light bg-light custom-mb">
    <div class="container">
    <a class="navbar-brand" href="?p=home">Multiversum</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="?p=home"><i class="fas fa-home"></i> Home <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="?p=admin">Admin Panel</a>
                <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="?p=afmelden">Afmelden</a>
            </div>
        </li>
        <?php endif; ?>
        </ul>
